...
$Host.UI.RawUI.WindowTitle = 'Natural Memory v2 Router 512 - Live Monitor'
...
while ($true) {
    ...
    Clear-Host
    Write-Host 'Natural Memory v2 - Router 512 Live Monitor' -ForegroundColor Cyan
